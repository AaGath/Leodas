...
async def start(client, message):
    ...
    buttons = [
                    [
                        InlineKeyboardButton('⚡ Join Group ⚡', url='https://t.me/Cinema_Kottaaram_2'),
                        InlineKeyboardButton('💥 Share 💥', url='https://t.me/share/url?url=https://t.me/Cinema_Kottaaram_2')
                    ]
    ]
